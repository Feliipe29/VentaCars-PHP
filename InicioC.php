...
<div class="row mt-3">
        ...
        <div class="col-md-4">
            <form action="" method="POST">
                <h3 class="text-center text-info">Inicio Sesión de Comprador!!</h3><br>
                ...
                <a href="indexC.php" class="btn btn-info btn-block">Iniciar</a>        
                <a href="index.php" class="btn btn-info btn-block">Regresar</a>        
